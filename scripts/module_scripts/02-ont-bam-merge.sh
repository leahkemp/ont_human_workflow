...
ls ${WKDIR}/results/01-cthulhu-guppy-gpu/pass/*.bam > ${WKDIR}/results/02-ont-bam-merge/${SAMPLE}/${SAMPLE}_bam_list.txt
...
rm -rf ${WKDIR}/results/02-ont-bam-merge/${SAMPLE}/${SAMPLE}_merged.bam
